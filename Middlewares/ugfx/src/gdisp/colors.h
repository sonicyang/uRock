...
#define Gray			(color_t)0xFF808080
#define Grey			Gray
#define uBlue			(color_t)0xFF0000FF
#define uRed			(color_t)0xFFFF0000
#define Fuchsia			(color_t)0xFFFF00FF
#define Magenta			Fuchsia
#define uGreen			(color_t)0xFF008000
#define Yellow			(color_t)0xFFFFFF00
#define Aqua			(color_t)0xFF00FFFF
#define Cyan			Aqua
#define Lime			(color_t)0xFF00FF00
#define Maroon			(color_t)0xFF800000
#define Navy			(color_t)0xFF000080
#define Olive			(color_t)0xFF808000
#define Purple			(color_t)0xFF800080
#define Silver			(color_t)0xFFC0C0C0
#define Teal			(color_t)0xFF008080
#define Orange			(color_t)0xFFFFA500
#define Pink			(color_t)0xFFFFC0CB
#define SkyBlue			(color_t)0xFF87CEEB
/** @} */
